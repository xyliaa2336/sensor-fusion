...
import argparse
import os
from lipreading_utils_grad import pad_sequences,find_data_mean, find_data_std, HDF5LipReadingIterator, HDF5LipReadingIterator_shift,HDF5LipReadingIterator_sep,ftensor5, get_train_and_val_fn, vocab_size, print_model
...
filename = 'lipreading_grid_video_coch'
new_filename=filename+'_shift_1'
vid_model_filename='lipreading_grid_video_48_3_best'
aud_model_filename='lipreading_grid_coch_ctime_40_on_0_best'
old_filename='lipreading_grid_video_coch_shift_0_recent'
blankout=0.5
aud_blankout=0.8
