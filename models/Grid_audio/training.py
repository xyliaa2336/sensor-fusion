...
from lipreading_models import get_dan_original_rnn,get_network,get_network_12classes,get_dan_original_audio
import h5py
...
h5file = '/home/xiaoya/lipreading/GridVideo_Audio_subset1.hdf5'
test_run_id='0'
# Get dataset
...
network = get_dan_original_audio(aud_in)
...
filename = 'lipreading_grid_audio_uni_dataset'
