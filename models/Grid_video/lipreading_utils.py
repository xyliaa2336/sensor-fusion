...
from lasagne_utils import save_model, store_in_log
    ...
    def flow(self, data_collection_video, data_collection_audio, datagroup_key, batch_size, shuffle=True, blankout=0, audio_blankout_prob=0.8):
        ...
        while b < num_batches:
            ...
            for key in curr_keys:
                ...
                curr_vid_data = get_hdf5_vid_data(data_collection_video, datagroup_key, key, mean_vid , std_vid)
                ...
                file_cnt=file_cnt+1
                try:
                    curr_aud_data = get_hdf5_aud_data(data_collection_audio, datagroup_key, key, mean_aud, std_aud)
                    ...
                    try:
                        curr_aud_data = get_hdf5_aud_data(data_collection_audio, the_other_key, key, mean_aud, std_aud)
                        f2=open('checked_aud_keys','a')
                        f2.write(key+'\n')
                        f2.close()
                    except Exception as e:
